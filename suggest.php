...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if($name == '')
    {
        $error_message = "Please fill the name field";
    }
    if($email == '')
    {
    ...
    if($category == '')
    {
        $error_message = "Please fill the category field";
    }
    if($title == '')
    {
        $error_message = 'Please fill the title field';
    }
    if(!isset($error_message) && $_POST['address'] != '')
    {
        $error_message = 'Surprise mother fucker!';
    }
   ...
   require("inc/phpmailer/PHPMailer.php");
    ...
    {
        $error_message = 'Invalid email address MF';
    }
    ...
    if (!isset($error_message))
    {
        ...
        $email_body .= 'Additional Details: '.$details. "\n";


        //Recipients
        $mail->setFrom($email, $name);
        $mail->addAddress('user@localhost.localdomain', 'Icko');
 ...
 include('inc/header.php');?>
    ...
    <div class="section page">
        <div class='wrapper'>
            ...
            {
                echo '<p>Thanks for the Email! I will review your suggestion shortly and contact with you!</p>';
            } else {
                if (isset($error_message))
                    {
                        ...
                        {
                            echo "<p>If you think I am missing something , please complete the form to send me an email.</p>";
                        }
            ?>
            <form method='post' action='suggest.php'>
                <table>
                    <tr>
                        ...
                        <td><input type='text' id='name' name='name' value='<?php if(isset($name)){ echo $name; }?>' required/></td>
                    </tr>
                    <tr>
                        <th><label for='email'>Email *</label></th>
                        <td><input type='email' id='email' name='email' value='<?php if(isset($email)){ echo $email; }?>' required /></td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                        ...
                        <td><input type='text' id='title' name='title' value='<?php if(isset($title)){ echo $title; }?>' required/></td>
                    </tr>
                  <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <tr>
                        ...
                        <td><input type='number'  max='<?php echo date('Y');?>'id='year' name='year' value='<?php if(isset($year)){ echo $year; }?>'/></td>
                    </tr>
                     <tr>
